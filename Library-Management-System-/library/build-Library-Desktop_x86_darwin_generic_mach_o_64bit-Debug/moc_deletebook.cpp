...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_deleteBook_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_deleteBook_t qt_meta_stringdata_deleteBook = {
    {
...
Q_CONSTINIT static const uint qt_meta_data_deleteBook[] = {
...
Q_CONSTINIT const QMetaObject deleteBook::staticMetaObject = { {
    ...
    qt_meta_stringdata_deleteBook.offsetsAndSizes,
    qt_meta_data_deleteBook,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_deleteBook_t,
        // Q_OBJECT / Q_GADGET
