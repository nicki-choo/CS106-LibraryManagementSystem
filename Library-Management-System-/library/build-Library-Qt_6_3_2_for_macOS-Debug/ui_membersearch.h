/********************************************************************************
** Form generated from reading UI file 'membersearch.ui'
**
...
#ifndef UI_MEMBERSEARCH_H
#define UI_MEMBERSEARCH_H
...
public:
    ...
    void setupUi(QDialog *membercatalogue)
    {
        if (membercatalogue->objectName().isEmpty())
            membercatalogue->setObjectName(QString::fromUtf8("membercatalogue"));
        membercatalogue->resize(894, 559);
        buttonBox = new QDialogButtonBox(membercatalogue);
        buttonBox->setObjectName(QString::fromUtf8("buttonBox"));
        buttonBox->setGeometry(QRect(20, 480, 341, 32));
        buttonBox->setOrientation(Qt::Horizontal);
        buttonBox->setStandardButtons(QDialogButtonBox::Cancel|QDialogButtonBox::Ok);
        frame_2 = new QFrame(membercatalogue);
...
"color: #2A3540;"));
        ...
        frame = new QFrame(membercatalogue);
...
""));
        ...
        QObject::connect(buttonBox, &QDialogButtonBox::accepted, membercatalogue, qOverload<>(&QDialog::accept));
        QObject::connect(buttonBox, &QDialogButtonBox::rejected, membercatalogue, qOverload<>(&QDialog::reject));

        QMetaObject::connectSlotsByName(membercatalogue);
    } // setupUi

    void retranslateUi(QDialog *membercatalogue)
    {
        membercatalogue->setWindowTitle(QCoreApplication::translate("membercatalogue", "Dialog", nullptr));
        coverLabel->setText(QString());
        ISBN->setText(QCoreApplication::translate("membercatalogue", "ISBN", nullptr));
        name->setText(QCoreApplication::translate("membercatalogue", "Name", nullptr));
        author->setText(QCoreApplication::translate("membercatalogue", "Author", nullptr));
        genre->setText(QCoreApplication::translate("membercatalogue", "Genre", nullptr));
        publisher->setText(QCoreApplication::translate("membercatalogue", "Publisher", nullptr));
        price->setText(QCoreApplication::translate("membercatalogue", "Price", nullptr));
        quantity->setText(QCoreApplication::translate("membercatalogue", "Quantity", nullptr));
        date->setText(QCoreApplication::translate("membercatalogue", "Date Received", nullptr));
        desc->setText(QCoreApplication::translate("membercatalogue", "Description", nullptr));
        label->setText(QCoreApplication::translate("membercatalogue", "Search", nullptr));
    } // retranslateUi
