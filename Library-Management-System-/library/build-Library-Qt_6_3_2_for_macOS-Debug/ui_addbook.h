...
public:
    ...
    void setupUi(QDialog *addBook)
    {
        ...
        addBook->resize(715, 699);
        addBook->setStyleSheet(QString::fromUtf8("background-color:#FFFFFF"));
...
"}"));
        ...
        chooseAuthBtn->setObjectName(QString::fromUtf8("chooseAuthBtn"));
...
"}"));
        ...
        chooseGenreBtn->setObjectName(QString::fromUtf8("chooseGenreBtn"));
...
"}"));
        ...
        horizontalSpacer = new QSpacerItem(208, 17, QSizePolicy::Fixed, QSizePolicy::Minimum);
...
"	border-color: #001873;"));
        ...
        horizontalSpacer_3 = new QSpacerItem(77, 20, QSizePolicy::Fixed, QSizePolicy::Minimum);

        horizontalLayout_6->addItem(horizontalSpacer_3);

        selectImgBtn = new QPushButton(frame_2);
        selectImgBtn->setObjectName(QString::fromUtf8("selectImgBtn"));
...
"}"));
        ...
        horizontalSpacer_4 = new QSpacerItem(77, 20, QSizePolicy::Fixed, QSizePolicy::Minimum);
...
"}"));
    ...
    void retranslateUi(QDialog *addBook)
    {
        ...
        label_8->setText(QCoreApplication::translate("addBook", "Publish Date", nullptr));
