...
public:
    ...
    void setupUi(QDialog *IssueBook)
    {
        ...
        IssueBook->resize(416, 607);
        IssueBook->setStyleSheet(QString::fromUtf8("background-color: rgb(255, 255, 255);"));
...
"color: #2A3540;"));
        ...
        available->setStyleSheet(QString::fromUtf8("font: 500 13pt \"Work Sans\";\n"
"color: #2A3540;"));
